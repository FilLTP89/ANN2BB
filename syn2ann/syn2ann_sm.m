...
%             plot(T_out,psa_acc_pro,'kd-','markerfacecolor','r');
...
%             hold all
%             plot(dtm*(0:numel(acc_pro)-1),acc_pro,'r');
%             plot(dtm*(0:numel(acc_proc)-1),acc_proc,'g');
%             figure
%             plot(smr.(hbs.mon.cp{j_}).mon.dtm(i_)*(0:numel(smr.(hbs.mon.cp{j_}).syn{i_}.tha.(hbs.mon.cp{j_}))-1),...
%                 smr.(hbs.mon.cp{j_}).syn{i_}.tha.(hbs.mon.cp{j_}),'b');
%             hold all
%             plot(dtm*(0:numel(dis_proc)-1),dis_proc,'r');
%             keyboard
