    ...
    for i_ = 1:hbs.mon.na
        for j_=1:hbs.mon.nc
            ...
            [~,smr.(hbs.mon.cp{j_}).syn{i_}.thv.(hbs.mon.cp{j_}),...
                ...
                integr_diff_avd(smr.(hbs.mon.cp{j_}).mon.dtm(i_),...
                smr.(hbs.mon.cp{j_}).syn{i_}.tha.(hbs.mon.cp{j_}));
...
%             close all
%             figure
%             plot(trs.(trs.mon.cp{j_}).mon.vTn,trs.(trs.mon.cp{j_}).syn{i_}.psa.(trs.mon.cp{j_})*100,'md');hold all;
%             plot(smr.(hbs.mon.cp{j_}).mon.vTn,smr.(hbs.mon.cp{j_}).syn{i_}.psa.(hbs.mon.cp{j_})*100,'b+-');hold all;
%             keyboard
            %
