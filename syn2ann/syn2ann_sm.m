...
function [varargout] = syn2ann_sm(varargin)
    ...
    for i_ = 1:hbs.mon.na
        for j_=1:hbs.mon.nc
            ...
            % _spectral scaling_
            figure
            plot(trs.(trs.mon.cp{j_}).mon.vTn,trs.(trs.mon.cp{j_}).syn{i_}.psa.(trs.mon.cp{j_}),'bo-','markerfacecolor','g');
            hold all;
%             
            [smr.(hbs.mon.cp{j_}).mon.dtm(i_),...
                ...
                trs.(trs.mon.cp{j_}).mon.vTn,0.8);...
                plot(smr.(hbs.mon.cp{j_}).mon.vTn,smr.(hbs.mon.cp{j_}).syn{i_}.psa.(hbs.mon.cp{j_}),'kd-','markerfacecolor','r');
%             [smr.(hbs.mon.cp{j_}).mon.dtm(i_),...
%                 smr.(hbs.mon.cp{j_}).syn{i_}.tha.(hbs.mon.cp{j_}),...
%                 smr.(hbs.mon.cp{j_}).syn{i_}.thv.(hbs.mon.cp{j_}),...
%                 smr.(hbs.mon.cp{j_}).syn{i_}.thd.(hbs.mon.cp{j_}),...
...
%                 smr.(hbs.mon.cp{j_}).syn{i_}.psa.(hbs.mon.cp{j_}),...
%                 smr.(hbs.mon.cp{j_}).syn{i_}.psd.(hbs.mon.cp{j_}),smr.(hbs.mon.cp{j_}).mon.vfr{1}] = ...
%                 spectral_scaling_corr...
