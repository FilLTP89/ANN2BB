...
switch  ttt
    ...
    case 'KMMH16(2) 2016-04-16 01:46'
        ...
        ylm.psa = {[0;3000]};
        ytk.psa = {(0:600:3000)'};
    case 'KMMH14(1) 2016-04-14 21:26'
        % *======================== KMM ==============================*
        %             vtm_shift(:) = 1.25;
        vtm_lim = [15;35];
        vtm_lab = (vtm_lim(1):5:vtm_lim(end));
        ...
        ylm.psa = {[0;900]};
        ytk.psa = {(0:300:900)'};
    case 'KMMH14(2) 2016-04-14 21:26'
        % *======================== KMM ==============================*
        %             vtm_shift(:) = 1.25;
        vtm_lim = [12;52];
        vtm_lab = (vtm_lim(1):5:vtm_lim(end));
        ...
        ylm.psa = {[0;3000]};
        ytk.psa = {(0:600:3000)'};
    case 'KMMH14(1) 2016-04-15 00:03'
        % *======================== KMM ==============================*
        %             vtm_shift(:) = 1.25;
        vtm_lim = [15;35];
        vtm_lab = (vtm_lim(1):5:vtm_lim(end));
        ...
        ylm.psa = {[0;600]};
        ytk.psa = {(0:200:600)'};
    case 'KMMH14(2) 2016-04-15 00:03'
        % *======================== KMM ==============================*
        %             vtm_shift(:) = 1.25;
        vtm_lim = [12;52];
        vtm_lab = (vtm_lim(1):5:vtm_lim(end));
        ...
        ylm.psa = {[0;3000]};
        ytk.psa = {(0:600:3000)'};
    case 'KMMH14(1) 2016-04-16 01:25'
        % *======================== KMM ==============================*
        %             vtm_shift(:) = 1.25;
        vtm_lim = [15;35];
        vtm_lab = (vtm_lim(1):5:vtm_lim(end));
        ...
        ylm.psa = {[0;1200]};
        ytk.psa = {(0:400:1200)'};
    case 'KMMH14(2) 2016-04-16 01:25'
        % *======================== KMM ==============================*
        %             vtm_shift(:) = 1.25;
        vtm_lim = [12;52];
        vtm_lab = (vtm_lim(1):5:vtm_lim(end));
