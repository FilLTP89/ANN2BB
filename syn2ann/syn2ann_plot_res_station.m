...
%             fn = fullfile(sp,sprintf('%s_hyb_ann_justPSA',st));
%             syn2ann_plot_compare(...
%                 [1 0 0 0 0],...
%                 {hbs;trs_justPSA.(cpp{j_})},...
%                 mm_(i_),...
%                 {'HYBRID';'ANN'},...
%                 (cpp{j_}),...
%                 fn,...
...
%             fn = fullfile(sp,sprintf('%s_spm_ann_justPSA',st));
%             syn2ann_plot_compare(...
%                 [1 0 0 0 0],...
%                 {spm_justPSA.(cpp{j_});...
%                 trs_justPSA.(cpp{j_})},...
...
%             fn = fullfile(sp,sprintf('%s_spm_rec_justPSA',st));
%             syn2ann_plot_compare(...
%                 [1 1 1 1 1],...
%                 {rec.org;spm_justPSA.(cpp{j_})},...
%                 mm_(i_),...
%                 {'RECORDED';'MATCHED'},...
%                 (cpp{j_}),...
%                 fn,...
