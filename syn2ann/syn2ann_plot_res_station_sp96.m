...
for j_ = 1:numel(cpp)
    ...
    syn2ann_plot_compare([1;0;0;0;0],{rec.org;pbs.sps;hbs.sps;spm.sps.(cpp{j_})},...
        mm_,dlg(j_),{'REC';'PBS';'HYB';'SPM'},(cpp{j_}),ttt,fnm,zeros(1,4),...
        {'none';'none';'none';'none'},...
        {'-';':';'--';'-'},...
        [4,1.5,1,2.5]);
    fnm = fullfile(sp,sprintf('%s_rec_pbs_hsp_ssp_%s',st,ann.(cpp{j_}).nl));
    syn2ann_plot_compare([0;1;0;0;0],{rec.org;pbs.sps;hbs.sps;spm.sps.(cpp{j_})},...
        mm_,dlg(j_),{'REC';'PBS';'HYB';'SPM'},(cpp{j_}),ttt,fnm,zeros(1,4),...
        {'none';'none';'none';'none'},...
        {'-';':';'--';'-'},...
        [1,1,1,1]);
...
%         [0 1 0 0 0],...
%         {pbs.sps;sps.org;pbs.hyb.sps;sps.hyb;hbs.sps},...
%         mm_,dlg(j_),...
%         {'';'';'PBS';'SP96';'HYB'},...
%         (cpp{j_}),bhr.nm{mm_},...
%         fnm,...
...
%     syn2ann_plot_compare(...
%         [1 0 0 0 0],...
%         {rec.org;pbs.hyb.sps;sps.hyb;hbs.sps},...
%         mm_,dlg(j_),...
%         {'REC';'PBS';'SP96';'HYB'},...
%         (cpp{j_}),bhr.nm{mm_},...
%         fnm,...
...
%     syn2ann_plot_compare(...
%         [1 1 0 0 0],...
%         {rec.org;pbs.sps;spm.sps.(cpp{j_})},...
%         mm_,dlg(j_),...
%         {'REC';'PBS';'SPM'},...
%         (cpp{j_}),bhr.nm{mm_},...
