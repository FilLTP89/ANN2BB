...
for j_ = 1:numel(cpp.rec)
    ...
    if any(strcmpi(flag.rec,flag.ann))
        ...
        disp('GEOMETRIC MEAN-> CHECK FLAGS FOR syn2ann_plot_compare')
        %         syn2ann_plot_compare(...
        %             [2 0 0 0 0],...
        %             [{rec.org};ann.scp],...
        %             mm_,dlg(j_),...
        %             {'REC-GMH';'$ALL\left(GH;T^\star-0.50 s\right)$';...
        %             '$ALL\left(GH;T^\star-0.75 s\right)$';...
        %             '$ALL\left(GH;T^\star-1.00 s\right)$'},...
        %             (cpp.rec{j_}),ttt,...
        %             fnm,...
        %             zeros(4,1),...
        %             {'none';'none';'s';'v'},...
        ...
        syn2ann_plot_compare(...
            ...
            [{rec.org};ann.scp],...
            mm_,dlg(j_),...
            {'REC-GMH';'$ALL\left(GH;T^\star-0.75 s\right)$';...
            '$ALL\left(GH;T^\star-0.25 s\right)$'},...
            (cpp.rec{j_}),ttt,...
            fnm,...
            zeros(4,1),...
            {'none';'none';'s';'v'},...
