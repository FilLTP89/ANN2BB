function train_ann_withPGV(varargin)
    %% *SET-UP*
    ann = varargin{1};
    wd = varargin{2};
...
%     format_figures(gca);rule_fig(gcf);
    ...
    switch ann.tc
        case 0.5
            save(fullfile(wd,sprintf('net_05s_%s_withPGV.mat',ann.cp)),'net');
        case 0.6
            save(fullfile(wd,sprintf('net_06s_%s_withPGV',ann.cp)),'net');
        case 0.75
            save(fullfile(wd,sprintf('net_075s_%s_withPGV',ann.cp)),'net');
        case 1.0
            save(fullfile(wd,sprintf('net_1s_%s_withPGV',ann.cp)),'net');
    end
    %     % Plot
