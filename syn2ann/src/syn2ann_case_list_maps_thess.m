...
% STORED IN COLUMNS
mtdd.sp96.mw = 6.5*ones(numel(monn.id),1);
...
%mtdd.sp96.ew = 3.0*ones(numel(monn.id),2); % in Hz 
%mtdd.sp96.ns = 3.0*ones(numel(monn.id),2); % in Hz 
%mtdd.sp96.ud = 3.0*ones(numel(monn.id),2); % in Hz 
mtdd.sp96.ew = 2.0*ones(numel(monn.id),2); % in Hz
mtdd.sp96.ns = 2.0*ones(numel(monn.id),2); % in Hz 
mtdd.sp96.ud = 2.0*ones(numel(monn.id),2); % in Hz 
