...
function train_ann_justPSA(varargin)
    ...
    ylm = [1e-2;1e1];
    fpplot('xpl',{NNs{bst.idx}.trs.epoch';NNs{bst.idx}.trs.epoch';NNs{bst.idx}.trs.epoch';...
    ...
    fpplot('xpl',xpl.trn,'ypl',ypl.trn,'pfg',[0,0,12,10],...
        ...
        'xlb',{'log_{10}(PSA-ANN)'},'xlm',{xlm.all+[0;1]},'xtk',{xtk},...
        'ylb',{'log_{10}(PSA-TAR)'},'ylm',{ylm.all},'ytk',{ytk},'leg',{leg});
