function [varargout] = ns_parser(varargin)
    ...
    % Copyright 2016
    % NOTES
    % ns_parser: function to parse synthetics from speed/hisada
    ...
    %         mon.cp = motion component         (integer: 1,2,3)
    %         mon.nc = number of components     (integer)
    %         nss    = structure of numerical simulations
    ...
    %         nss.syn(mon.na,1)     = structure vectors (cell vector)
    ...
    % N.B. Need for speed_monitor_name.m,hisada_monitor_name.m,vel2acc.m,
    % dis2acc.m,PGAVD_eval.m
    %===============
    %======================================================================
    % SET-UP
    %======================================================================
    mon = varargin{1};    % monitor structure
    %======================================================================
    %======================================================================
    % PARSING METADATA
    %======================================================================
