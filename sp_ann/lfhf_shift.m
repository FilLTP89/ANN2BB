    ...
    for i_ = 1:nss.mon.na
        for j_ = 1:nss.mon.nc
            ...
            [sps.syn{i_}.tha.(nss.mon.cp{j_}),...
                ...
                band_pass_filter(sps.mon.dtm(i_),hf(:),[],[]);
            
            [sps.syn{i_}.pga.(sps.mon.cp{j_})(1),sps.syn{i_}.pga.(sps.mon.cp{j_})(2),...
                sps.syn{i_}.pgv.(sps.mon.cp{j_})(1),sps.syn{i_}.pgv.(sps.mon.cp{j_})(2),...
                sps.syn{i_}.pgd.(sps.mon.cp{j_})(1),sps.syn{i_}.pgd.(sps.mon.cp{j_})(2)] = ...
                PGAVD_eval(sps.mon.dtm(i_),sps.syn{i_}.tha.(sps.mon.cp{j_}),...
                sps.syn{i_}.thv.(sps.mon.cp{j_}),sps.syn{i_}.thd.(sps.mon.cp{j_}));
            
            [sps.syn{i_}.AT5.(sps.mon.cp{j_}),....
                        sps.syn{i_}.AI5.(sps.mon.cp{j_}),...
                        sps.syn{i_}.Ain.(sps.mon.cp{j_})] = ...
                        arias_intensity(sps.syn{i_}.tha.(sps.mon.cp{j_}),...
                        sps.mon.dtm(i_),I1);
