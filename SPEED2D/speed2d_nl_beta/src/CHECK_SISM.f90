...
subroutine CHECK_SISM(cs_nnz,cs,nm,tag_mat,sdeg_mat,ne,nl_sism,num_node_sism,max_num_node_sism,&
        sour_node_sism,dist_sour_node_sism,check_node_sism,check_dist_node_sism,length_cns,&
                        ...
                        do j = 1,nn   
                            do i = 1,nn
                                ...
                                if (in.eq.sour_node_sism(k,isism)) then
                                    ...
                                    check_dist_node_sism(h,1) = dist_sour_node_sism(k,isism)/vel_rup
