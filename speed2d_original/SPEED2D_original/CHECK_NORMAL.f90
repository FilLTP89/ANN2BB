...
!> @param[out] yon  1 if the normals are opposite 0 otherwise
      ...
      real*8 :: nor_x, nor_y, res                        
      real*8, dimension(nel_glo,2) :: normalxyz
      ...
      do i = 1, nel_glo
         ...
         if(material .eq. mat_el_fac(i,1) .and. &
            ...
            res = dsqrt(dabs(nor_x + normalxyz(i,1))**2 + dabs(nor_y + normalxyz(i,2))**2)
